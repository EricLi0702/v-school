                ...
                <div class="es-item" v-if="j == 0">
                    <div class="w-100">
                            ...
                            <div class="es-item">
                                <div class="es-item-left">
                                    <div class="text-color">
                                        平均{{sentence.answerData}}，总计{{sentence.answerData}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div v-else-if="type == '评分题'">
                            <div class="text-color">
                                平均{{sentence.selMinute}}分，总计{{sentence.selMinute}}分
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-100">
                        <div v-if="type == '单选题' || type == '多选题'" style="height:100%">
                            <div style="display:flex;height:100%"> 
                                <div :class="{selAnswer: sentence.isActive }" ></div>
                        ...
                        <!-- <div v-if="type == '多选题'" style="height:100%">
                            <div style="display:flex;height:100%"> <div :class="{selAnswer: sentence.isActive  }" ></div>{{alphabet[j-1]}} : {{sentence.title}}</div>
                            <div class="media row">
                                <div class="image-item col-12" v-if="sentence.imgUrl.length">
                                    <div class="image-block row">
                                        <div class="image-upload-list col-1" v-for="(imgUrl,k) in sentence.imgUrl" :key="k">
