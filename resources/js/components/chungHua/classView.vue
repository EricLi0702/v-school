        ...
        <div class="es-space es-branch ml-0">
            <div class="es-contacts">
                ...
                <div class="es-info-container">
                    <div class="es-scroller" style="width:100%;height:705px;overflow:hidden;outline:none;">
                            ...
                            <div class="scroll-container">
                                ...
                                <div>
                                    ...
                                    <div class="contact-con-class-view">
                                        <div class="contact-user vx-item" v-for="contact in contacts" :key="contact.name">
