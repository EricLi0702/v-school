                        ...
                        <div class="d-flex option-box" v-for="(sentence,j) in questionData.questionDataArr" :key="j">
                            <div class="es-item">
                                <div class="es-item-left">
                                    ...
                                    <span v-else-if="questionData.selQuestion == '填空题'">第{{j+1}}空.</span>
                                    <span class="pl-2" v-html="sentence.contentData"></span>
                                    <span v-if="questionData.selQuestion == '判断题'">{{sentence}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="category-title" v-if="questionData.selQuestion == '单选题' || questionData.selQuestion == '多选题' || questionData.selQuestion == '填空题'">正确答案</div>
